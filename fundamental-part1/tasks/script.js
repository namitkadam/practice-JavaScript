...
console.log("massMark", BMIMark, "hightJohn", BMIJohn);
...
const johnBMI = johnmass / johnHight ** 2;
console.log("markMass", markBMI, "johnmass", johnBMI);
// const BMImarkHigher = markBMI > johnBMI;
// console.log("BMImarkHigher", BMImarkHigher);
