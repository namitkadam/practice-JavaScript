...
const koalasScores = calcAverage(65, 54, 45);
const dolphinsScores = calcAverage(44, 23, 71);
...
console.log(checkWinner(dolphinsScores2, koalasScores2));
checkWinner(1101, 110);
checkWinner(11, 29);
...
for (let i = 0; i < bills.length; i++) {
  ...
  console.log(
    `The bill amount is ${bills[i]} and the tip is ${tips[i]}. So, the total amount is ${totals[i]}`
  );
}
