...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  dogs.forEach(function (dog, i) {
    if (dog >= 3) {
      console.log(`Dog number ${i + 1}is an adult and ${dog}year old`);
    } else {
...
// const average2 = calcAverageHumanAge([5, 2, 4, 1, 15, 8, 3]);
...
// 8
const doesSorted = dogs.slice().sort((a, b) => a.recFood - b.recFood);
console.log(doesSorted);
